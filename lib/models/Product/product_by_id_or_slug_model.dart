class ProductByIdOrSlugModel {
  ProductByIdOrSlugModel({
  ...
  factory ProductByIdOrSlugModel.fromJson(Map<String, dynamic> json) {
    return ProductByIdOrSlugModel(
      status: json["status"],
      message: json["message"],
      data: json["data"] == null
          ? null
          : Datum.fromJson(json["data"]), // <-- direct parse, no .map()
    );
  }
}
