...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json){ 
        return Datum(
            ...
            careInstructions: json["careInstructions"] == null ? [] : List<String>.from(json["careInstructions"]!.map((x) => x)),
            ...
            completeLook: json["completeLook"] == null ? [] : List<dynamic>.from(json["completeLook"]!.map((x) => x)),
